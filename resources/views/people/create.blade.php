                        ...
                        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                            ...
                            <form class="kt-form" id="kt_user_add_form">
                                ...
                                <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                                    <div class="kt-heading kt-heading--md">Dados do Perfil:</div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="kt-section__body">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar">
                                                                    ...
                                                                    <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="Upload de Foto">
                                                                        <i class="fa fa-pen"></i>
                                                                        <input type="file" name="img_profile">
                                                                    </label>
                                                                    <span class="kt-avatar__cancel" data-toggle="kt-tooltip" title="Remover">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Nome Completo</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control" type="text" value="" placeholder="Digite o nome completo" name="name">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="usuario@suaoficina.com.br" aria-describedby="basic-addon1">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control" type="text" name="dateBirth" placeholder="dd/mm/AAAA">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="cel" value="" placeholder="Telefone" aria-describedby="basic-addon1">
                                                                </div>
                                                                <span class="form-text text-muted"></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group form-group-last row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group">
                                                                    <textarea name="description" id="" cols="90"
                                                                              rows="10"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="kt-section__body">
                                                        <div class="form-group row">
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="kt-section__title kt-section__title-md">Detalhes de Acesso</h3>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
