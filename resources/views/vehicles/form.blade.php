        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-toolbar">
                <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" data-toggle="tab" href="#kt_user_edit_tab_3" role="tab" id="user_edit_tab_3">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" data-toggle="tab" href="#kt_user_edit_tab_4" role="tab" id="user_edit_tab_4">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group" id="input-cel">
                                                ...
                                                <input type="text" id="cel" class="form-control tab-info phone" value="@if($edit) {{ $person->cel }}  @endif" required placeholder="(15) 99999-9999"  aria-describedby="basic-addon1">
                                            </div>
                    ...
                    <div class="kt-form kt-form--label-right">
                        <div class="kt-form__body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-xl-5">
                                    <a href="javascript:" onclick="clean_fields('tab-address')" class="btn btn-default" style="float:right;">
                                        <i class="fas fa-broom"></i>
                                        Limpar
                                    </a>
                                </div>
